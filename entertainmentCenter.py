...
extraordinario = media.Movie(
    ...
    "http://br.web.img3.acsta.net/c_215_290/pictures/17/11/28/18/32/3262971.jpg",
...
belezaOculta = media.Movie(
    ...
    "http://br.web.img2.acsta.net/c_215_290/pictures/16/10/13/21/27/038061.jpg",
...
logan = media.Movie(
    ...
    "http://br.web.img3.acsta.net/c_210_280/pictures/16/10/05/19/59/363613.jpg",
...
alfa = media.Movie(
    ...
    "https://m.media-amazon.com/images/M/MV5BODI4OTk1ODY3N15BMl5BanBnXkFtZTgwMDI1MTcwNjM@._V1_UX182_CR0,0,182,268_AL_.jpg",
...
detonaRalph = media.Movie(
    ...
    "http://3.bp.blogspot.com/-fb1bk17945I/UUSOJHh-b1I/AAAAAAAAFFo/DKu2yKoJNTQ/s1600/Detona-Ralph-poster-brasil.jpg",
...
movies = [
    extraordinario, belezaOculta, logan, alfa,
    oLoboDeWallStreet, naNaturezaSelvagem, detonaRalph
]
